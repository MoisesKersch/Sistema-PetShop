								...
								<div class="col s12 m6 l3">
									<div class="card">
										<div class="card-content blue-grey white-text">
											...
											<p class="card-stats-compare">
												<i class="mdi-hardware-keyboard-arrow-up"></i> 80% <span class="blue-grey-text text-lighten-5">Ontem</span>
											</p>
										</div>
								...
								<div class="col s12 m6 l3">
									<div class="card">
										<div class="card-content deep-purple white-text">
											<p class="card-stats-title">
												<i class="mdi-editor-insert-drive-file"></i> Serviços em Aberto
											</p>
											<h4 class="card-stats-number">${servicoAberto}</h4>
											<p class="card-stats-compare">
												<i class="mdi-hardware-keyboard-arrow-down"></i> 3% <span class="deep-purple-text text-lighten-5">Último Mês</span>
											</p>
										</div>
							...
							<div class="row">
								<div class="col s12 m6 l3">
									<div class="card">
										<div class="card-content  green white-text">
											<p class="card-stats-title">
												<i class="mdi-action-get-app"></i> Serviços Agendados
											</p>
											<h4 class="card-stats-number">${servicoAgendado}</h4>
											<p class="card-stats-compare">
												<i class="mdi-hardware-keyboard-arrow-up"></i> <br> <span class="green-text text-lighten-5"></span>
											</p>
										</div>
										<div class="card-action  green darken-2">
											<div id="clients-bar"></div>
								...
								<div class="col s12 m6 l3">
									<div class="card">
										<div class="card-content purple white-text">
											<p class="card-stats-title">
												<i class="mdi-action-done"></i>Compras Concluídas
											</p>
											<h4 class="card-stats-number">${servicoConcluido}</h4>
											<p class="card-stats-compare">
												<i class="mdi-hardware-keyboard-arrow-up"></i> <span class="purple-text text-lighten-5"><br></span>
											</p>
										</div>
										<div class="card-action purple darken-2">
											<div id="sales-compositebar"></div>
								...
								<div class="card">
									<div class="card-move-up waves-effect waves-block waves-light">
										<div class="move-up cyan darken-1">
											<div>
												<span class="chart-title white-text">Receita</span>
												<div class="chart-revenue cyan darken-2 white-text">
													<p class="chart-revenue-total">R$ 4,500.85</p>
													<p class="chart-revenue-per">
														<i class="mdi-navigation-arrow-drop-up"></i> 21.80 %
													</p>
												</div>
												<div class="switch chart-revenue-switch right">
													<label class="cyan-text text-lighten-5"> Mês <input type="checkbox"> <span class="lever"></span> Ano
													</label>
												</div>
											</div>
									...
									<div class="card-content">
										...
										<div class="col s12 m2 l2">
											<ul class="doughnut-chart-legend">
												<li class="mobile ultra-small"><span class="legend-color"></span>Banho</li>
												<li class="kitchen ultra-small"><span class="legend-color"></span> Tosa</li>
												<li class="home ultra-small"><span class="legend-color"></span> Vacinas</li>
											</ul>
										</div>
									...
									<div class="card-reveal">
										<span class="card-title grey-text text-darken-4">Receita Mensal <i class="mdi-navigation-close right"></i></span>
										<table class="responsive-table">
											<thead>
												<tr>
													<th data-field="id">ID</th>
													<th data-field="month">Mês</th>
													<th data-field="item-sold">Serviço</th>
													<th data-field="item-price">Preço</th>
