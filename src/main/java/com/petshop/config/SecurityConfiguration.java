...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter
{
	...
	{
		// seleciona a opção e configura suas propiedades, query que busca por username, query que busca por autoridades, fonte de dados (database), configuração de encriptografia.
	...
	// configuração de permissão para urls no sistema, padrão todas estão bloqueadas, mais abaixo estaremos liberando algumas
	protected void configure(HttpSecurity httpSecurity)
	{
		...
		httpSecurity.authorizeRequests()
			...
			.antMatchers("/home/**").hasAuthority("ADMIN").anyRequest() // acesso total a url "home" caso a role seja "ADMIN"
