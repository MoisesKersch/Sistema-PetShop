          ...
          .extend(
              altEditor.prototype,
              {
                ...
                _setup : function() {
                  ...
                  // add Edit Button
                  if (this.s.dt.button('edit-categoria:name')) {
                    this.s.dt.button('edit-categoria:name').action(
                  ...
                  // add Delete Button
                  if (this.s.dt.button('delete-categoria:name')) {
                    this.s.dt.button('delete-categoria:name').action(
                        function(e, dt, node, config) {
                          var rows = dt.rows({
                            selected : true
                          }).count();
                  ...
                  // add Add Button
                  if (this.s.dt.button('add-categoria:name')) {
                    this.s.dt.button('add-categoria:name').action(
                        function(e, dt, node, config) {
                          var rows = dt.rows({
                            selected : true
                          }).count();
                ...
                _openEditModal : function() {
                  ...
                  $('#editing-servico-categoria').val("true")	
                ...
                _openDeleteModal : function() {
                     ...
                     $('#servico-categoria-remove-modal').openModal();
                     $('#servico-categoria-remove-id').val(adata.data()[0][columnDefs[2].name])
                },
                ...
                _openAddModal : function() {
                	...
                	$('#servico-categoria-form')[0].reset();
                	$('#servico-categoria-form-modal').openModal();
