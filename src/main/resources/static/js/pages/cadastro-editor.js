          ...
          .extend(
              altEditor.prototype,
              {
                ...
                _openEditModal : function() {
                  ...
                  $('#cidade').val( adata.data()[0]['enderecos'][0][columnDefs[4].name])
                  $('#uf').val( adata.data()[0]['enderecos'][0][columnDefs[5].name]);
                  $('#complemento').val( adata.data()[0]['enderecos'][0][columnDefs[6].name])
                  $('#id').val(adata.data()[0][columnDefs[7].name])	
                  $('#editing').val("true")	
